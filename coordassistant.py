...
class CoordsBuilderApp:
    ...
    def _build_ui(self):
        ...
        help_text = (
            "Instructions:\n"
            "1. Load a coords.json template.\n"
            "2. Load the matching jersey blank image.\n"
            "3. Select an element to edit and ensure it is included.\n"
            "4. Drag on the canvas to create a box; adjust corners as needed.\n"
            "5. Adjust rotation or preview text when available.\n"
            "6. Repeat for needed elements and save."
        )
    ...
    def on_include_toggle(self):
        ...
        if entry["active"]:
            ...
            self._clear_preview(self.current_element)
        self._refresh_listbox_labels()
